...
describe 'Visitante vê quartos' do
  ...
  it 'somente habilitados' do
    ...
    expect(page).not_to have_content('Área do Quarto: 40m²')
    expect(page).not_to have_content('Camas confortáveis')
    expect(page).not_to have_content('Ocupação Máxima: 4')
    expect(page).to have_content('Não há quartos disponíveis')
  end
